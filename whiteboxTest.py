...
from fastai.vision.all import (BCEWithLogitsLossFlat, DataLoader, ResNet34_Weights,
                               resnet34, unet_learner, DynamicUnet, MixedPrecision)
...
if __name__ == "__main__":
    ...
    model = create_unet_model(resnet34, n_out=1, img_size=(256, 256), pretrained=True, weights=ResNet34_Weights.DEFAULT)
